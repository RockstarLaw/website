...
/**
 * PaymentCashRegister — Cash register easter egg for the 1:1 payment clone.
 *
 ...
 *   2. Plays the cash-register sound (same logic as CashRegisterButton.tsx):
 ...
 *
 * This approach is compatible with dangerouslySetInnerHTML — the component
 * attaches listeners after hydration, without modifying the visible DOM.
 */
